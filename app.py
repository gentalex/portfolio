...
st.set_page_config(
    page_title=" Alexandre Genter - Portfolio",  # Titre de la page
    page_icon="📈",
...
st.sidebar.markdown(
    ...
    <p style="margin: 0; font-weight: bold; font-size: 14px;">
        <img src="https://img.icons8.com/ios-filled/16/000000/user.png"/> : <strong>GENTER Alexandre</strong>
    </p>
    """,
    unsafe_allow_html=True
)
...
with st.sidebar.expander("Contactez moi"):
    ...
    st.markdown("<p style='margin-bottom: 0;'><img src='https://img.icons8.com/ios-filled/16/000000/phone.png'/> : 06 44 39 63 68</p>", unsafe_allow_html=True)

    # Email avec icône et lien mailto
    st.markdown("<p style='margin-bottom: 0;'><img src='https://img.icons8.com/ios-filled/16/000000/email.png'/> : <a href='mailto:genter.alexandre@gmail.com'>genter.alexandre@gmail.com</a></p>", unsafe_allow_html=True)
    ...
    st.markdown("<p style='margin-bottom: 0;'><img src='https://img.icons8.com/ios-filled/16/000000/linkedin.png'/> : <a href='https://www.linkedin.com/in/alexandre-genter/' target='_blank'>Mon LinkedIn</a></p>", unsafe_allow_html=True)

    # GitHub avec icône et lien
    st.markdown("<p style='margin-bottom: 0;'><img src='https://img.icons8.com/ios-glyphs/16/000000/github.png'/> : <a href='https://github.com/gentalex' target='_blank'>Mon GitHub</a></p>", unsafe_allow_html=True)
...
# Utilisation de f-string pour formater la taille de la police dans le texte
    ...
    st.write("Ancien Chargé d’Affaires Professionnels dans le secteur bancaire, j’ai développé une forte expertise en analyse financière, gestion des risques et prise de décision stratégique. Passionné par la data, j’ai entrepris une reconversion pour exploiter la puissance de l’analyse de données dans l’optimisation des performances et la prise de décision.")
